...
public class Zwerchau extends CustomCard {

    public static final String ID = "Zwerchau";
    public static final String NAME = "Zwerchau";
    public static final String DESCRIPTION = "Deal !D! damage. Adds a Redoublement to your hand.";
    public static final String IMG_PATH = "img/card/zwerchau.png";
    ...
    public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        ...
        this.addToBot(new MakeTempCardInHandAction(new Redoublement()));
    }
